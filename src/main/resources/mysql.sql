...
(
    ...
    FOREIGN KEY (USER_ID) REFERENCES capsule.USERS (ID) ON DELETE CASCADE
);
CREATE INDEX BRANCH_USER_BRANCH_ID_INDEX ON capsule.BRANCH_USER (BRANCH_ID);
CREATE INDEX BRANCH_USER_USER_ID_INDEX ON capsule.BRANCH_USER (USER_ID);
-- -----------------------------------------------------------
...
(
    ...
    BRANCH_ID       INTEGER,
    FOREIGN KEY (BRANCH_ID) REFERENCES capsule.BRANCHES (ID) ON DELETE NO ACTION,
    CREATED         TIMESTAMPTZ  NOT NULL,
    MODIFIED        TIMESTAMPTZ  NOT NULL
);

CREATE INDEX PRODUCTS_PRODUCT_TYPE_ID_INDEX ON capsule.PRODUCT_TYPES (ID);
CREATE INDEX PRODUCTS_BRANCH_ID_INDEX ON capsule.BRANCHES (ID);
...
-- -----------------------------------------------------------------------------------
CREATE TABLE capsule.CUSTOMERS
(
    ID       SERIAL       NOT NULL PRIMARY KEY,
...
(
    ...
    DESCRIPTION  TEXT                  DEFAULT NULL,
    USER_ID      INTEGER,
    FOREIGN KEY (USER_ID) REFERENCES capsule.USERS (ID) ON DELETE NO ACTION,
    CUSTOMER_ID  INTEGER,
    FOREIGN KEY (CUSTOMER_ID) REFERENCES capsule.CUSTOMERS (ID) ON DELETE NO ACTION,
    CREATED      TIMESTAMPTZ  NOT NULL,
    MODIFIED     TIMESTAMPTZ  NOT NULL
);
CREATE INDEX ORDERS_USERS_ID_INDEX ON capsule.ORDERS (USER_ID);
CREATE INDEX ORDERS_CUSTOMER_ID_INDEX ON capsule.ORDERS (CUSTOMER_ID);


CREATE TABLE capsule.ORDER_ITEMS
(
    ID              SERIAL       NOT NULL PRIMARY KEY,
    PRICE_AMOUNT    VARCHAR(255) NOT NULL,
    ...
    PRODUCT_ID      INTEGER,
    FOREIGN KEY (PRODUCT_ID) REFERENCES capsule.PRODUCTS (ID) ON DELETE NO ACTION,
    ORDER_ID        INTEGER,
    FOREIGN KEY (ORDER_ID) REFERENCES capsule.ORDERS (ID) ON DELETE NO ACTION,
    BILL_DATE       TIMESTAMPTZ  NOT NULL,
    CREATED         TIMESTAMPTZ  NOT NULL,
    MODIFIED        TIMESTAMPTZ  NOT NULL
);
CREATE INDEX ORDER_ITEM_PRODUCT_ID_INDEX ON capsule.ORDER_ITEMS (PRODUCT_ID);
CREATE INDEX ORDER_ITEM_ORDER_ID_INDEX ON capsule.ORDER_ITEMS (ORDER_ID);

-- -----------------------------------------------------------------------------------

CREATE TABLE capsule.INVOICES
(
    ID          SERIAL       NOT NULL PRIMARY KEY,
...
COMMENT ON COLUMN capsule.INVOICES.TYPE IS 'SALE, BUY';
...
drop table capsule.ORDERS CASCADE;
drop table capsule.ORDER_ITEMS CASCADE;
drop table capsule.INVOICES CASCADE;
drop table capsule.ATTRIBUTE_VALUE_PRODUCT_TYPE CASCADE;
